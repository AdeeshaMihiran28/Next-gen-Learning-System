...
from app.schemas.proctoring import AlertType, AlertEvent, Severity, StatusUpdate
...
try:
    ...
    os.environ.setdefault(
        "YOLO_CONFIG_DIR",
        str(BASE_DIR / "assets" / "ultralytics")
    )
...
BASE_DIR = Path(__file__).resolve().parents[2]
YOLO_MODEL_PATH = BASE_DIR / "assets" / "models" / "yolov8n.pt"
